...
- [☑️] Clone your OWN fork of the repository using your terminal.
- [☑️] CD into the project base directory.
- [☑️] Download project dependencies by running `npm install`.
- [☑️] Start up the app using `npm start`.
- [☑️] Optionally run tests using `npm test`. (The app must be running on `http://localhost:1234`)
